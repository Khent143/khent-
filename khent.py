...
author = 'khent ortiz'
faceb0ok = 'Tawga rakog mangaon na'
version = 'single'
...
khe       ntkhe                                                nt
khe     nt  khe                              nt              khe
khent       khent khe khent khe khent khekhent khe
khent       khe       nt khent khe khe        ntkhe
khe     nt  khe       nt khe            khe        ntkhe
khe      nt khe       nt khent khe khe        nt khe
{50*"="}
[√] AUTHOR  : Khent Ortiz
[√] FACEBOOK: Tawga Rakog Manga on na
[√] GITHUB  : https://github.com/Khent143/khent-
[√] Status  : para rani sa mga single
[★]VIRSION  : single 1
{50*"="}""")
def logo2():
	return str(f"""
...
def cek_opsi_cp():
	...
	except:sys.exit(f" [{M}>{P}] There isn't any KHENT💔 cp")
	for x in ok:
		nom.append(x)
		no+=1
...
def cek_HASAN():
	no,nom = 0,[]
	one = input(f' [{hh}1{P}] KHENT💚 akun ok\n [{hh}2{P}] cek KHENT💔 akun cp\n menu : ')
	if one in ['1','01']:
		try:ok = os.listdir('OK')
		except:sys.exit(f" [{M}>{P}] KHENT💚 ok")
		for x in ok:
			nom.append(x)
			no+=1
			try:jum= open('OK/'+x,'r').readlines()
		...
		try:ok = os.listdir('CP')
		except:sys.exit(f" [{M}>{P}] KHENT💔 cp")
		for x in ok:
			nom.append(x)
			no+=1
			try:jum= open('CP/'+x,'r').readlines()
...
def crack_search():
	Name = []
	custom = [" muhammad","finnela","lafy","jayco harold","arabela","mestola","daril john","jefford","carl","jepoy","jeffoy","jeffrey","anna","sara","marilou","khent","aprilyn","joyce","joyce beluggolo","rose","warain"," firman"," pratama"," tyz"," galau"," semarang"," boyolali"," cilacap"," kebumen"," banyumas"," herex"," tuban"," sumedang"," aja"," new"," baru"," setia"," sayang"," cinta"," syank kamu"," cantik"," ganteng"," imut"," kalem"," sragen"," susah sembuh"," sudah sembuh"," sakit"," wae"," sulung"," nur"," dwi"," x gans"," x jebe"," x cogan"," x id"," ganong"," situbondo"," aremania"," sunda"," garut"," cirebon"," sukabumi"," medan"," thejack"," bobotoh"," bonek"," suroboyo"," surabaya"," persebaya"," persib"," persija"," cilacap"," jepara"," solo"," official"," manis"," imut"," kalem"," utama"," sukses"," real"," semok"," kesepian"," rentcar"," makmur"," jaya"," jr"," tasik"," malang"," jogja"," mama"," ibuknya"," bundanya"," tiktok"," kece"," keren"," baru"," jutek"," saja"," putri"," andi"," dewi"," tri"," dian"," sri"," putri"," eka"," sari"," aditya"," basuki"," budi"," joni"," toni"," bekti"," cahya"," harahap"," riski"," farhan"," aden"," joko"," firman"," sulis"," soleh"," gagal"," kacau"," sulis"," rahmat"," indah"," pribadi"," saputro"," saputra"," kediri"," kudus"," jember"," situbondo"," pemalang"," wonosobo"," trenggalek","  tuban"," gresik"," bangkalan"," jombang"," kediri"," lamongan"," lumajang"," madiun"," magetan"," mojokerto"," nganjuk"," pacitan"," ngawi"," pasuruan"," ponorogo"," pamengkasan"," sidoarjo"," tuban"," blitar"," kediri"," banjarnegara"," batang"," blora"," brebes"," grobokan"," karanganyar"," kendal"," klaten"," kudus"," pati"," pekalongan"," rembang"," sragen"," tegal"," temanggung"," wonogiri"," wonosobo"," sukoharjo"," salatiga"," bandung"," ciamis"," cianjur"," cirebon"," indramayu"," majalengka"," subang"," sumedang"," purwakarta"," banjar"," bekasi"," bogor"," comahi"," depok"," tasikmalaya "]
	custom2 = ["mamah ","ibuk ","mayo","jessable","main","lyn","lebara","bunda ","ayah ","om ","muhammad ","putra ","gagah ","namaku ","panggeran ","putri ","dewi ","joko ","sri ","dwi ","cinta ","sayang ","riski ","pesulap ","mamanya ","tante ","bu ","pakde ","juli ","emak "]
...
def cari_nama(link):
	...
	try:
		link = r.find('a',string=' KHENT💔 Selanjutnya').get('href')
		if(link):
			print('\r being dumped %s id'%(len(dump)),end=" ")
			sys.stdout.flush()
			cari_nama(link)
